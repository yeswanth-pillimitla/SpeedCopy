        ...
        {statsCards.map((card, idx) => (
          ...
          >
            ...
            <div className="flex items-center gap-1.5 mt-1">
              <span className={`text-[11px] font-bold px-1.5 py-0.5 rounded-full flex items-center gap-0.5 leading-none w-fit shrink-0 ${card.isPositive
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3.5 text-center">
                        <span className={`inline-block px-2 py-0.5 rounded-full text-[10.5px] font-bold ${cust.status === 'Active'
                            ? 'bg-[#DEF7EC] text-[#03543F]'
